minetest.register_on_mapgen_init(function()
    ...
    local mob_list = {
        ...
        pteranodon = {intrvl = 5, chance = 0.5, group = 6, biomes = {unpack(highlandbiomes), unpack(biomes)}, nodes = {'group:soil', 'default:permafrost_with_stones'}},
        quetzalcoatlus = {intrvl = 5, chance = 0.5, group = 6, biomes = {unpack(highlandbiomes), unpack(biomes)}, nodes = {'group:soil', 'default:permafrost_with_stones'}},
